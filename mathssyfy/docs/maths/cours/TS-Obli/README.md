...
::: tip Exercice 
\newcommand{\formetrigo}[2]{#1\left(\cos\left(#2\right)+i\sin\left(#2\right)\right)}
Donner la forme algébrique des nombres complexes suivants

1.  $\formetrigo{2}{\frac{\pi}{2}}$

2.  $\formetrigo{5}{\frac{\pi}{3}}$

3.  $\cos(\pi)+i\sin(\pi)$

4.  $\formetrigo{3}{\frac{3\pi}{2}}$

5.  $\formetrigo{\sqrt{2}}{\frac{2\pi}{3}}$

6.  $\formetrigo{\frac{2}{3}}{-\frac{\pi}{6}}$

7.  $\formetrigo{2}{\frac{4\pi}{3}}$
...
::: tip Exercice 
En utilisant les formule d'Euler (exercice \ref{ex|formuleseuler}), établir les identités suivantes
...
2.  $\frac{1}{\raisebox{-.2cm}{$e^{i\frac{\pi}{{7}}}$}}$

3.  $\frac{e^{i\frac{\pi}{{5}}}}{\raisebox{-.2cm}{$e^{{4}i\frac{\pi}{5}}$}}$
...
\input{figures/figures-texgraph/lecture-module-arg.tkz}

1.  A l'aide des éléments codés sur la figure, déterminer les formes trigonométriques puis algébriques des affixes des points $A$, $B$, $C$

2.  On note $D$ le point d'affixe $1$. Un élève affirme que le triangle $BCD$ est équilatéral. On donne ci-dessous le calcul qu'il a fait sur sa calculatrice pour le vérifier :

\includegraphics[height=2cm]{figures/screen-TI/ex76_0}
\includegraphics[height=2cm]{figures/screen-Casio/ex76_0}

a)  Expliquer le calcul fait.
...
:::
::: tip Exercice 
En utilisant les formules d'Euler (exercice \ref{ex|formuleseuler}), établir les identités suivantes :
...
1.  A l'aide d'une factorisation par $e ^{i\frac{\theta}{2}}$ démontrer que $z_{\theta}= e^{i \frac{\theta}{2}}\times 2\cos\theta$ (on pourra employer les formules de l'exercice \ref{ex|formuleseuler}).
